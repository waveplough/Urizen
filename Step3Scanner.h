...
extern urizen_str tokenStrTable[NUM_TOKENS];
...
urizen_int	nextClass(urizen_char c);					/* character class function */
urizen_int	nextState(urizen_int, urizen_char);		/* state machine function */
